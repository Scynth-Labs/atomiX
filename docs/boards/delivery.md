...
AX-07 is closed. The same-binary CPU experiment now owns versioned exact-output,
identity, size, and deterministic-cycle bounds for its three preview
candidates. A per-change stage reruns that small comparison and proves its own
